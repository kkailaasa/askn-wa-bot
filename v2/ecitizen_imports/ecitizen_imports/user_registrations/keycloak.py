...
@silk_profile(name="user_registration.keycloak.register_user_with_keycloak")
...
@silk_profile(name="user_registration.keycloak.get_user")
def get_user(email: str):
    keycloak_admin = __create_admin()
    users = keycloak_admin.get_users({"email":email})
    return users

@silk_profile(name="user_registration.keycloak.update_by_phone_number")
...
@silk_profile(name="user_registration.keycloak.get_user_by_phone")
...
@silk_profile(name="user_registration.keycloak.update_epassport_number")
...
@silk_profile(name="user_registration.keycloak.enable")
